...
char *pynurs_nlmsg_string[NURS_PYIPC_T_MAX + 1] = {
	...
	[NURS_PYIPC_T_REQ_TIMER_REGISTER] =	"REQ_TIMER_REGISTER",
	[NURS_PYIPC_T_REQ_ITIMER_REGISTER] =	"REQ_ITIMER_REGISTER",
	[NURS_PYIPC_T_REQ_TIMER_UNREGISTER] =	"REQ_TIMER_UNREGISTER",
	...
	[NURS_PYIPC_T_ACK_TIMER_REGISTER] =	"ACK_TIMER_REGISTER",
	[NURS_PYIPC_T_ACK_ITIMER_REGISTER] =	"ACK_ITIMER_REGISTER",
	[NURS_PYIPC_T_ACK_TIMER_UNREGISTER] =	"ACK_TIMER_UNREGISTER",
